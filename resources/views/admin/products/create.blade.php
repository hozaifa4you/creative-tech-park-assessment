<x-app-layout>
    <div class="py-4">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <form class="space-y-6 p-6" action="{{ route('dashboard.products.store') }}" method="POST"
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <input hidden name="categories" value="[]" id="categories">
    ...
    @section('scripts')
        <script src="@vite(['resources/js/select.js'])"></script>
    @endsection
    @section('css')
